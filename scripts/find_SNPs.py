...
def main(args):
	...
	snp_reference,mut_reference,lineage_dict,lineage_list = sf.load_reference_snps(SNPtable)
	...
	for query in args.Query:
		...
		snps,snp_list = sf.extract_from_snpfile(prefix,snp_reference,mut_reference,reference_fasta)
		snps_dict[ID] = snps
	...
	sf.print_list(snp_lists_dict,list_out_file)
